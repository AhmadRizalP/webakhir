  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer" >
        <a href="http://localhost/webakhir/keranjang/prosestambah.php?id_buku=<?= $idbuku ?>" style="border: 1px solid black; margin-right: 122px" type="button" class="btn">Lanjutkan Berbelanja</a>
    ...
    <ul class="nav nav-tabs ">
      ...
      <li class="nav-item">
        <a class="nav-link" href="http://localhost/webakhir/buku/detail2.php?id_buku=<?= $idbuku ?>">Detail</a>
      </li>
