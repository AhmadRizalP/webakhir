...
$query = mysqli_query($connect,"SELECT * FROM buku ORDER BY stok ");
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item active" href="#">Terpopuler</a>
    <a class="dropdown-item" href="http://localhost/webakhir/buku/index2.php">Terbaru</a>
    <a class="dropdown-item" href="http://localhost/webakhir/buku/index3.php">Harga Terendah</a>
    <a class="dropdown-item" href="http://localhost/webakhir/buku/index4.php">Harga Tertinggi</a>
  </div>
    </div>
        <div class="isi">
